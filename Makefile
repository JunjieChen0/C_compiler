...
clean:
	rm -f src/*.o tests/test_lexer.exe tests/test_type.exe tests/test_sym.exe tests/test_gen.exe tests/test_pe.exe tests/test_ir.exe tests/test_errors.exe
	rm -f tests/programs/*.s
